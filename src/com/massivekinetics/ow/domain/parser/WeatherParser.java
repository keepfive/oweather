package com.massivekinetics.ow.domain.parser;

import android.util.Log;
import com.massivekinetics.ow.domain.model.WeatherForecast;
import com.massivekinetics.ow.domain.model.WeatherModel;
import com.massivekinetics.ow.domain.parser.strategies.CurrentWeatherStrategy;
import com.massivekinetics.ow.domain.parser.strategies.GeneralWeatherStrategy;
import com.massivekinetics.ow.domain.parser.strategies.JsonParserStrategy;
...
import static com.massivekinetics.ow.domain.parser.WeatherConstants.CURRENT_CONDITION;
import static com.massivekinetics.ow.domain.parser.WeatherConstants.WEATHER;
import static com.massivekinetics.ow.services.utils.StringUtils.isNullOrEmpty;
...
public class WeatherParser {
	...
	private WeatherModel getCurrentWeather(JSONObject generalData)
		...
		JSONObject currentConditionObject = generalData.getJSONObject(CURRENT_CONDITION);
	...
	private void mergeCurrentConditions(List<WeatherModel> generalForecast,
		...
		if (!generalForecast.isEmpty()
			...
			if (currentWeatherModel.getWindDirection() != null)
				forecastModel.setWindDirection(currentWeatherModel.getWindDirection());
		}
	}
