...
import com.massivekinetics.ow.domain.adapters.WeatherPagerAdapter;
...
import com.massivekinetics.ow.services.utils.*;
import com.massivekinetics.ow.ui.views.SwipeIndicatorPresenter;
...
public class ForecastPageActivity extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        dataManager = AppLocator.resolve(IDataManager.class);
        checkIntent();
        initViews();
        initListeners();
    }
